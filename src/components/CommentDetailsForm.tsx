...
const CommentDetailsForm = ({ post, setPost }: { post: Post, setPost: React.Dispatch<React.SetStateAction<Post>> }) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:3001/post/${post.id}/comment`, {
                method: 'POST',
                headers: {
